    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO DE USUARIOS <small class="tittles-pages-logo">NesthuG Bikes</small></h1>
            </div>
            ...
            <div class="row">
				...
				<p><i class="fa fa-users fa-5x"></i></p>
                    ...
                    <figure>
                      <img src="./assets/img/img-registration.jpg" width="500px"  height="500px "alt="store" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
